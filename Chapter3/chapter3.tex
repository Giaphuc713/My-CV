...
- Nhóm 1 - Đánh giá cấu trúc đồ thị (SHACL): Chuẩn SHACL của W3C được lựa chọn vì có thể kiểm tra ràng buộc cấu trúc đồ thị mà không yêu cầu tập dữ liệu nhãn thủ công. Chuẩn này giúp tìm kiếm các Nút mồ côi (Dangling Nodes) thông qua duyệt đồ thị có hướng để phát hiện các đỉnh không có mối quan hệ kết nối, ngăn chặn tình trạng tri thức bị phân mảnh. Đồng thời, Độ phủ văn bản (Chunk Coverage) được đo lường để đảm bảo không bỏ sót thông tin trọng yếu.

- Nhóm 2 - Đánh giá độ hữu cơ của quan hệ (LLM-as-a-Judge): Phương pháp này đánh giá độ lắng đọng trích xuất, với tiêu chí cốt lõi là Độ có cơ sở (Groundedness). Đánh giá này bắt buộc mọi mối quan hệ phải tồn tại chứng cứ tường minh từ các đoạn văn bản gốc, ngăn chặn hiện tượng âm tính giả và ảo giác của LLM.
