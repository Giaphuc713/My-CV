...
\textbf{Đánh giá chất lượng đồ thị tri thức.}

Khác với việc đánh giá toàn trình (end-to-end) của một hệ thống RAG thông thường thông qua các bộ khung như RAGAS hay ARES \cite{ragas2023} – vốn chỉ đánh giá chất lượng của câu trả lời đầu ra cuối cùng, nghiên cứu này chú trọng vào việc đo lường chất lượng nội tại của đồ thị (intrinsic graph quality). Việc dựa vào các phương pháp đánh giá đồ thị truyền thống như dự đoán liên kết (link prediction) cũng không khả thi, do đồ thị tạo bởi mô hình ngôn ngữ có lược đồ mở và cần được đánh giá dựa trên mức độ trung thực so với văn bản gốc.

Để giải quyết vấn đề này, nghiên cứu áp dụng phương pháp đánh giá "LLM-as-a-Judge" được lấy cảm hứng từ nghiên cứu của Edge và cộng sự \cite{edge2024}, kết hợp với các tiêu chuẩn kiểm định Ontology. Quá trình đánh giá được triển khai trên ba khía cạnh cốt lõi nhằm giải quyết triệt để các hạn chế của việc trích xuất đồ thị tự động đã được đề cập ở Chương 2. 

Trước tiên, việc kiểm tra tính toàn vẹn của cấu trúc đồ thị (Graph Structure Health) được thực hiện thông qua xác định các nút mồ côi (dangling nodes) và đo lường tỷ lệ bao phủ văn bản. Bước đánh giá này nhằm giải quyết vấn đề phân mảnh của đồ thị, đảm bảo rằng các thực thể trích xuất ra thực sự tạo thành một mạng lưới tri thức liên kết chặt chẽ thay vì là những mảnh thông tin rời rạc, đồng thời đánh giá được năng lực bao quát dữ liệu của hệ thống. 

Tiếp theo, độ chính xác của quá trình trích xuất (Extraction Correctness) được đo lường bằng cách lấy mẫu ngẫu nhiên các quan hệ và yêu cầu một mô hình ngôn ngữ đóng vai trò giám khảo đối chiếu trực tiếp với văn bản gốc để chấm điểm tính có căn cứ (groundedness). Phép đo này đặc biệt quan trọng nhằm giải quyết vấn đề ảo giác (hallucination) thường gặp ở các mô hình ngôn ngữ lớn, qua đó cam kết độ tin cậy và tính trung thực tuyệt đối của dữ liệu sinh ra. 

Cuối cùng, hệ thống kiểm định tính hợp lệ của lược đồ (Ontology Validation) thông qua khả năng trả lời các câu hỏi năng lực (Competency Questions) và rà soát các lỗi thiết kế phổ biến. Bước này giúp khắc phục tình trạng trôi dạt lược đồ (schema drift) hay trích xuất phi cấu trúc, đảm bảo rằng đồ thị đáp ứng đúng các yêu cầu truy vấn nghiệp vụ chuyên sâu của hệ thống giáo dục.

Đối với vai trò giám khảo trong quá trình đánh giá (LLM-as-a-Judge), nghiên cứu tiếp tục sử dụng mô hình Qwen2.5-72B-Instruct. Như đã được phân tích và biện luận chi tiết ở các phần trước, mô hình này không chỉ đáp ứng được yêu cầu khắt khe về năng lực suy luận phức tạp, khả năng xử lý tiếng Việt xuất sắc, mà còn tối ưu hóa về mặt chi phí và tốc độ.
