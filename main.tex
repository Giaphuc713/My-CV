...
% ========================================================================================= %
\newcommand{\tenSV}{Nguyễn~Chí~Danh~-~Lý~Trường~Nam~-~Phạm~Tấn~Nghĩa} % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
...
\include{Chapter4_ThietKeUngDung/chapter4_thietke}
