...
\newcounter{propsec}
\newcounter{propsubsec}[propsec]
\newcounter{propsubsubsec}[propsubsec]
\renewcommand{\thepropsubsec}{\thepropsec.\arabic{propsubsec}}
\renewcommand{\thepropsubsubsec}{\thepropsubsec.\arabic{propsubsubsec}}

\stepcounter{propsec}
\section*{\thepropsec\quad Thông tin chung}
...
Thời gian thực hiện: Từ \textit{01/2026} đến \textit{07/2026}

\stepcounter{propsec}
\section*{\thepropsec\quad Nội dung thực hiện}

\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Giới thiệu về đề tài}
...
\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Mục tiêu đề tài}

\stepcounter{propsubsubsec}
\subsubsection*{\thepropsubsubsec\quad Tại sao cần thực hiện đề tài này?}
...
\stepcounter{propsubsubsec}
\subsubsection*{\thepropsubsubsec\quad Đề tài mang lại được điều gì?}
...
\stepcounter{propsubsubsec}
\subsubsection*{\thepropsubsubsec\quad Ảnh hưởng và ý nghĩa của kết quả đề tài}
...
\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Phạm vi của đề tài}
...
\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Cách tiếp cận dự kiến}
...
\begin{itemize}[label={--}, leftmargin=1.5em]
    \item Khảo sát nhu cầu của sinh viên về các tính năng và nghiệp vụ cần quan tâm liên quan đến tư vấn lộ trình học tập, tài liệu môn học để xây dựng một hệ thống tư vấn học tập hoàn chỉnh cho sinh viên.
...
\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Kết quả dự kiến của đề tài}
...
\stepcounter{propsubsec}
\subsection*{\thepropsubsec\quad Kế hoạch thực hiện}
{\small
\begin{longtable}{|C{0.9cm}|C{2.2cm}|C{2.2cm}|L{5.8cm}|L{2.4cm}|}
    \hline
...
\pagebreak
\nocite{graphrag2024,lightrag2024,graphrepo,stepchain2025,rag_survey2023}
...
\footnotesize
    ...
    XÁC NHẬN\newline CỦA NGƯỜI HƯỚNG DẪN\newline \textit{(Ký và ghi rõ họ tên)} & \textit{TP. Hồ Chí Minh, ngày 16 tháng 03 năm 2026}\newline NHÓM SINH VIÊN THỰC HIỆN\newline \textit{(Ký và ghi rõ họ tên)}
    \end{tabular}
\end{table}
