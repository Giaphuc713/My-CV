...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{images/system_architecture_ver3.drawio.png}
...
Sau khi xác thực thành công, yêu cầu được định tuyến đến Controller rồi chuyển xuống lớp Services để thực thi logic nghiệp vụ. Khi cần bổ sung thông tin tư vấn từ AI vào kết quả phản hồi, lớp Services chủ động gửi yêu cầu Fetch AI Advice sang Tầng Điều phối AI và tích hợp kết quả nhận được vào phản hồi cuối cùng trả về cho Client. Cuối cùng, lớp Data Access sử dụng Spring Data JPA và Hibernate để ánh xạ đối tượng và giao tiếp với cơ sở dữ liệu PostgreSQL thông qua giao thức JPA/JDBC.

\subsection{Tầng Điều phối AI (AI Processing Layer)}

Tầng Điều phối AI là trung tâm xử lý trí tuệ nhân tạo của hệ thống, tiếp nhận câu hỏi từ sinh viên thông qua hai luồng đầu vào: luồng trực tiếp từ Client qua Chat \& AI Direct Connection và luồng gián tiếp từ Tầng Nghiệp vụ qua yêu cầu Fetch AI Advice.
...
Sau khi có đầy đủ ngữ cảnh, hệ thống gửi yêu cầu suy luận (Inference) xuống Tầng Dữ liệu để Foundation Models tạo ra câu trả lời cuối cùng và trả về cho người dùng.

\subsection{Tầng Dữ liệu và Hạ tầng (Data \& Infrastructure Layer)}

Tầng này gồm ba thành phần lưu trữ, mỗi thành phần phục vụ một mục đích khác nhau trong hệ thống.
...
Ngoài ra, hệ thống còn xây dựng một kho tri thức học vụ dưới dạng Đồ thị Tri thức (Knowledge Graph) thông qua LightRAG. Đây là thành phần cốt lõi của toàn bộ luồng tư vấn AI, mọi câu trả lời của hệ thống đều được truy xuất từ đồ thị này. Kiến trúc lưu trữ chi tiết của LightRAG được trình bày tại Phần~\ref{sec:lightrag_storage}.
