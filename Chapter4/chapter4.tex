...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/dangki.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/dangnhap.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/quenmk.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/check_email.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/profile.jpg} 
    \caption{Giao diện Màn hình Thông tin cá nhân}
    \label{fig:ui_profile_info}
\end{figure}

Mục đích: Cho phép sinh viên khai báo và cập nhật hồ sơ học tập cá nhân, làm dữ liệu đầu vào để hệ thống RAG cá nhân hóa nội dung tư vấn môn học và lộ trình học tập.

Bao gồm:
\begin{enumerate}
    \item Trường "Ngành đào tạo": Danh sách chọn ngành học hiện tại của sinh viên.
    \item Trường "Năm học hiện tại": Danh sách chọn năm học của sinh viên.
    \item Trường "Định hướng nghề nghiệp": Ô nhập văn bản tự do để sinh viên mô tả mục tiêu nghề nghiệp.
    \item Nút chức năng "Đóng" và "Lưu thay đổi".
\end{enumerate}

Cách sử dụng:
Để cập nhật hồ sơ học tập:
\begin{enumerate}
    \item Người dùng mở bảng "Hồ sơ học tập sinh viên" từ màn hình AI Chat.
    \item Chọn ngành đào tạo và năm học hiện tại tương ứng từ danh sách sổ xuống.
    \item Nhập định hướng nghề nghiệp mong muốn vào ô văn bản.
    \item Nhấn nút "Lưu thay đổi" để hệ thống ghi nhận và đồng bộ hồ sơ học tập vào bộ nhớ dài hạn phục vụ cho AI Agent.
\end{enumerate}

Để đóng bảng thông tin mà không lưu thay đổi:
\begin{enumerate}
    \item Nhấn nút "Đóng" hoặc biểu tượng "X" ở góc trên bên phải của bảng.
\end{enumerate}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{chat_mode.jpg}
...
\begin{enumerate}
	...
	\item Ô nhập câu hỏi, danh sách chọn Mode và nút gửi (phía dưới)
\end{enumerate}
...
Để lựa chọn chế độ trả lời:
\begin{enumerate}
	\item Flash: Tốc độ phản hồi nhanh, độ trễ thấp; phù hợp cho câu hỏi đơn giản, tra cứu nhanh, hỏi đáp thông thường, sử dụng model nhẹ hơn nên tiết kiệm tài nguyên.
	\item Pro: Tốc độ phản hồi chậm hơn một chút nhưng chất lượng câu trả lời cao hơn, suy luận sâu, xử lý câu hỏi phức tạp, nhiều ràng buộc hoặc cần độ chính xác cao, sử dụng model mạnh hơn, ưu tiên độ chính xác và mức độ chi tiết.
\end{enumerate}
