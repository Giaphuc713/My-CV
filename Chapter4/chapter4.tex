...
\begin{enumerate}
	\item Flash (mặc định, dùng được cả khi chưa đăng nhập): truy vấn ít dữ liệu hơn, trả lời ngắn gọn, tóm tắt trọng tâm, không phân tích chi tiết, ưu tiên tốc độ.
	\item Pro (yêu cầu đăng nhập): truy vấn sâu hơn, AI thực hiện phân tích từng bước để đưa ra lộ trình học chi tiết, đầy đủ theo đúng ngành/khóa, ưu tiên độ chính xác và chiều sâu.
\end{enumerate}
