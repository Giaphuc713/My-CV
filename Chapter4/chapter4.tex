...
- Thanh lịch sử hội thoại (bên trái)
	
- Khu vực hiển thị hội thoại (trung tâm)
	
- Ô nhập câu hỏi và nút gửi (phía dưới)
...
- Nhập câu hỏi vào ô nhập liệu ở phía dưới màn hình.
		
- Nhấn nút gửi.
		
- Hệ thống phân tích câu hỏi, truy xuất đồ thị tri thức và trả về câu trả lời chi tiết trong khu vực hội thoại.
	
	
- Để xem lại lịch sử hội thoại:
	
		
- Chọn phiên hội thoại tại thanh danh sách bên trái.
		
- Hệ thống hiển thị toàn bộ nội dung của phiên đó.
