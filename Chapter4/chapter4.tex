...
Chất lượng sinh văn bản của hệ thống được đo lường khắt khe dựa trên khung đánh giá RAGAS (Retrieval-Augmented Generation Assessment) \cite{es2023ragas}, mang lại những kết quả khả quan trên bộ 200 câu hỏi chuẩn. Yếu tố nổi bật nhất là Độ liên quan của câu trả lời (Answer Relevance) đạt mức 88.76\%, chứng tỏ các phản hồi sinh ra đáp ứng đúng trọng tâm truy vấn của sinh viên, vượt trội rõ rệt so với các phương pháp RAG truyền thống \cite{lewis2020rag}. Để hỗ trợ cho sự chính xác này, hệ thống duy trì Độ trung thực (Faithfulness) ở mức 76.07\%; kết quả này minh chứng cho khả năng bám sát ngữ cảnh từ Đồ thị tri thức, qua đó hạn chế tối đa việc mô hình bị "ảo giác" (Hallucination) hoặc tự bịa đặt thông tin \cite{ji2023survey}. Thêm vào đó, thông qua cơ chế Graph-aware Retrieval lấy cảm hứng từ GraphRAG \cite{edge2024graphrag}, Độ gọi bối cảnh (Context Recall) cũng đạt 76.01\%, cho thấy hệ thống có khả năng truy xuất thành công các khái niệm phân tán vốn là thách thức lớn đối với kỹ thuật Vector Search thông thường.

\section{Đánh giá hiệu năng điều phối Đa tác nhân (Agentic Metrics)}
Việc tích hợp kiến trúc LangGraph mang lại sự linh hoạt lớn cho hệ thống nhưng đồng thời cũng đặt ra bài toán về hiệu năng tính toán. Quá trình kiểm định cho thấy Tác nhân Orchestrator hoạt động vô cùng hiệu quả với tỷ lệ điều phối đúng công cụ (Routing Accuracy) đạt độ chính xác cao, đặc biệt trong việc phân loại ý định người dùng để điều hướng tới luồng truy xuất phù hợp (Local, Global hoặc Hybrid). Bất chấp sự phức tạp của luồng đa tác nhân, tốc độ phản hồi (Average Latency) vẫn được tối ưu ở mức chấp nhận được, với thời gian trung bình từ lúc nhận câu hỏi đến khi xuất ra câu trả lời hoàn chỉnh đạt 7.32 giây.
