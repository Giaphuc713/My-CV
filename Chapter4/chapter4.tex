...
Mục đích: Cung cấp biểu mẫu cho phép người dùng mới tạo tài khoản cá nhân để đăng nhập và sử dụng hệ thống LearningPath.
...
Mục đích: Xác thực danh tính của người dùng nhằm cấp quyền truy cập vào các tính năng chuyên sâu bên trong hệ thống.
...
Để xử lý khi gặp sự cố mật khẩu hoặc chưa có tài khoản:
\begin{enumerate}
...
Mục đích: Hỗ trợ người dùng cấp lại mật khẩu mới.
...
Cách sử dụng:
Bước 1: Gửi yêu cầu khôi phục mật khẩu từ hệ thống
\begin{enumerate}
...
Bước 2: Thực hiện kiểm tra hộp thư và tiến hành thiết lập mật khẩu mới
\begin{enumerate}
...
Mục đích: Hiển thị hồ sơ chi tiết của người dùng, và cập nhật thông tin cá nhân.

Bao gồm:
\begin{enumerate}
    \item Thông tin tóm tắt: Hiển thị ảnh đại diện, họ và tên, số điện thoại, email liên hệ, ngày vào học và vai trò người dùng.
    \item Thông tin cá nhân: Hiển thị chi tiết các dữ liệu học vụ và thông tin cá nhân.
\end{enumerate}

Cách sử dụng:
Để xem thông tin người dùng:
\begin{enumerate}
...
Mục đích: Cung cấp không gian trò chuyện trực tiếp giữa sinh viên và AI Agent để được tư vấn thông tin học vụ, lộ trình môn học và quy chế đào tạo.
...
Mục đích: Cung cấp biểu mẫu cho phép người dùng mới khởi tạo tài khoản cá nhân trên thiết bị di động để đăng nhập và sử dụng hệ thống LearningPath.
...
Để quay lại màn hình Đăng nhập:
\begin{enumerate}
...
Mục đích: Xác thực danh tính của người dùng nhằm cấp quyền truy cập vào các tính năng chuyên sâu bên trong hệ thống trên phân hệ di động.
...
Mục đích: Hỗ trợ người dùng gửi yêu cầu cấp lại mật khẩu mới thông qua liên kết khôi phục gửi tới thư điện tử cá nhân.
...
Cách sử dụng:
Để gửi yêu cầu khôi phục mật khẩu từ hệ thống:
\begin{enumerate}
	\item Người dùng nhập chính xác địa chỉ Email đã dùng để đăng ký tài khoản vào ô dữ liệu.
...
Để hủy bỏ thao tác và quay về màn hình trước:
\begin{enumerate}
...
Mục đích: Cung cấp không gian tương tác hội thoại trực tiếp giữa sinh viên và AI Agent để tra cứu môn học, tư vấn lộ trình đào tạo cá nhân hóa và giải đáp các thắc mắc về học chế tín chỉ.
...
Để điều phối trạng thái tài khoản và xem lại lịch sử:
\begin{enumerate}
...
Mục đích: Giúp người học theo dõi trực quan tổng số tín chỉ học phần tích lũy hiện hành dựa trên cột mốc giới hạn 138 tín chỉ tốt nghiệp bắt buộc và quan sát danh sách lộ trình gợi ý học tập tiếp theo do AI Agent đề xuất.
...
Cách sử dụng:
Để kiểm tra thanh tiến độ và danh sách khuyến nghị học phần:
\begin{enumerate}
...
Mục đích: Hiển thị chi tiết toàn bộ thông tin định danh cá nhân học vụ của sinh viên và hỗ trợ cập nhật, chỉnh sửa thông tin liên lạc.
...
Cách sử dụng:
Để tra cứu hồ sơ học tập cá nhân:
\begin{enumerate}
