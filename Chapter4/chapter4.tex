...
Liên quan đến quyết định loại bỏ khâu gộp thực thể (Merge Quality), như đã biện luận ở Chương 3, kết quả chạy thực nghiệm trực tiếp đã xác nhận tính đúng đắn của quyết định này. Các cụm thực thể bị nghi ngờ trùng lặp (Suspicious Duplicates) hầu hết đều rơi vào các học phần có tên gần giống nhau nhưng hoàn toàn độc lập về nội dung, điển hình như Anh Văn 2 và Anh Văn 3 với độ tương đồng cosine lên đến 0.971. Việc áp dụng thuật toán gộp máy móc trong trường hợp này sẽ sinh ra các chuỗi quan hệ sai lệch nghiêm trọng, làm sai lệch lộ trình học tập của sinh viên.
